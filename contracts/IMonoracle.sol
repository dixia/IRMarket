...
/// @title IMonoracle
/// @notice Minimal interface for the upstream Monoracle veto-arbitrage oracle.
///         Exposes only what IRMarket touches.
interface IMonoracle {
    enum QuoteStatus {
    ...
    struct Quote {
        ...
        uint32 expiryBlock;     // vetoable until this block (inclusive)
